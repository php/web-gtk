<?php
define('DEFAULTHEADER', '"en":PHP-GTK - Documentation:"PHP-GTK Documentation":"PHP-GTK,PHP,GTK,DOCUMENTATION"');
...
define('TH1','Formats');
define('TH2','Languages');
define('TD1','A single HTML file');
define('TD2','Many HTML files');
define('TD3','TXT');
define('TD4','PDF');
