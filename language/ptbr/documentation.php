<?php
define('DEFAULTHEADER', '"pt-BR":"PHP-GTK - Documentação":"Documentação do PHP-GTK+.":"PHP-GTK,PHP,GTK, DOCUMENTAÇÂO"');
...
define('WELCOME','Ajudenos a fazer a documentação do PHP-GTK: php-gtk-doc@lists.php.net');
define('TITLE1','Baixe a documentação');
define('TH1','Formatos');
define('TH2','Idiomas');
define('TD1','Um único arquivo html');
define('TD2','Muitos arquivos HTML');
define('TD3','TXT');
define('TD4','PDF');
...
define('COPYRIGHT','Direitos autorais © 2001-2015 Equipe PHP-GTK. Todos os direitos reservados.*Último update:  Sábado Dezembro 12 04:58:12 2015 UTC');
